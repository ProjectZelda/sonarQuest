TRUNCATE TABLE Sonar_Config RESTART IDENTITY CASCADE;

TRUNCATE TABLE Level RESTART IDENTITY CASCADE;

TRUNCATE TABLE Avatar_Class RESTART IDENTITY CASCADE;

TRUNCATE TABLE Avatar_Race RESTART IDENTITY CASCADE;

TRUNCATE TABLE Skill RESTART IDENTITY CASCADE;

TRUNCATE TABLE Avatar_Class_Skill RESTART IDENTITY CASCADE;
TRUNCATE TABLE Artefact RESTART IDENTITY CASCADE;
TRUNCATE TABLE Artefact_Skill RESTART IDENTITY CASCADE;
TRUNCATE TABLE Role RESTART IDENTITY CASCADE;
TRUNCATE TABLE Permission RESTART IDENTITY CASCADE;
TRUNCATE TABLE Role_To_Permission RESTART IDENTITY CASCADE;
TRUNCATE TABLE _User RESTART IDENTITY CASCADE;
TRUNCATE TABLE Ui_Design RESTART IDENTITY CASCADE;
TRUNCATE TABLE User_Artefact RESTART IDENTITY CASCADE;

INSERT INTO Sonar_Config (name, sonar_server_url) VALUES
  ('Quests of Standard Bank', 'https://sonarcloud.io');
...
INSERT INTO _User (username, password, role_id, gold, xp, level_id, picture, about_me, avatar_class_id, avatar_race_id)
 VALUES ('admin', '$2a$10$LoXVU5ODwytMz3Mh/Nft4.WaasCtwEuN6NEeJCER5X8o1ayCJHVxO', 3,   0,   0, 1, 'maleWarrior.jpg', 'Quick with the keys as well as the daggers, Eddie knows hidden paths to chambers of wisdom unknown!', 4, 2);
INSERT INTO _User (username, password, role_id, gold, xp, level_id, picture, about_me, avatar_class_id, avatar_race_id) 
 VALUES ('dev',   '$2a$10$LoXVU5ODwytMz3Mh/Nft4.WaasCtwEuN6NEeJCER5X8o1ayCJHVxO', 2, 0, 0, 1, 'femaleElf.png', 'The little Witch is a pro with poisons and her broomstick.', 6, 1);
INSERT INTO _User (username, password, role_id, gold, xp, level_id, picture, about_me, avatar_class_id, avatar_race_id)
 VALUES ('gm',    '$2a$10$LoXVU5ODwytMz3Mh/Nft4.WaasCtwEuN6NEeJCER5X8o1ayCJHVxO', 1,   0,   0, 1, 'femaleWarrior.jpg', 'The mighty barbarian has the strength and the tools to do the job. Brute force ftw!', 2, 3);
